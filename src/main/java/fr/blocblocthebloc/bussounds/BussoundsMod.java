 ...
 *
 */
package fr.blocblocthebloc.bussounds;
...
@Mod("bussounds")
public class BussoundsMod {
	public static final Logger LOGGER = LogManager.getLogger(BussoundsMod.class);
	public static final String MODID = "bussounds";
